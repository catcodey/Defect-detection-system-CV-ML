...
def locknutdetect(output_path):
    ...
    model=YOLO("TRAINED_MODEL _16_12_24/TRAINED_MODEL/true weights for close up lock nut/best (21).pt")
    # Run inference on an image
    results = model(output_path,conf=0.2)
    '''
    for res in results:
        res.show()
    '''
...
def locknutclassi(output_path):
    ...
    im3 = r'C:\Users\yd196\Desktop\FINAL PROJECT\runs\detect\classify'
...
def locknut():
    ...
    for i in range(1):
        ...
        # LOCK NUT WEIGHTS
        model1 = YOLO("TRAINED_MODEL _16_12_24/TRAINED_MODEL/true weights for close up lock nut/locknut detetction yolov8s 100ep.pt")  # Replace with the path to your trained model weights
        ...
        #model=YOLO("C:/Users/yd196/Desktop/project1/eclip/best (4).pt")
        # Path to the image for prediction

    # image_path = "C:/Users/yd196/Pictures/Camera Roll/WIN_20240618_11_04_12_Pro.jpg"  # Replace with your image file
    # model =YOLO(r"C:\Users\yd196\Desktop\lock nut final working\best pt yolov8m 100ep lock nut better imgs.pt")
        #C:\Users\yd196\Pictures\Camera Roll\.jpg
        #model =YOLO(r"C:\Users\yd196\Desktop\hose pipe final working\hose pipe crimp 300ep best (20) pt.pt")

        #model =YOLO(r"C:\Users\yd196\Desktop\hose pipe final working\hose pipe crimp 300ep best (20) pt.pt")
        #model =YOLO(r"C:\Users\yd196\Downloads\eclips 8s 100ep best (20) pt.pt")
        #image_path=r"C:\Users\yd196\Desktop\test for screw\i3.jpg"

        #C:\Users\yd196\Pictures\Camera Roll\WIN_20240830_16_27_50_Pro.jpg
        #C:\Users\yd196\Pictures\Camera Roll\WIN_20240830_16_24_45_Pro.jpg
        #C:\Users\yd196\Pictures\Camera Roll\WIN_20240830_16_26_42_Pro.jpg

        
        #C:\Users\yd196\Pictures\Camera Roll\WIN_20240618_11_01_35_Pro.jpg
        #vid_path="C:/Users/yd196/Desktop/ENGINE VIDEOS/vid2.mp4"
        ...
        results = model1.predict(source=image_path, save=False,conf=0.5) #prev 0.3
        
     
        
        #vinomodel=model.export(format="openvino")
        #results = model.track(source=vid_path, save=True,tracker="C:/Users/yd196/Desktop/project1/config.yaml")
    
    
        #vinomodel=YOLO("best 100ep 8n_openvino_model")
    
        # Display the results
        
        #print(results)
        
        #vinoresult=vinomodel(image_path)
        
        # Optionally, save the prediction results to a file
        #results.save(save_dir="C:\\Users\\yd196\\Desktop\\project1\\predictions")
        for idx, result in enumerate(results):
            for box_id, box in enumerate(result.boxes):
                ...
                results1 = model2.predict(source=cropped_image, save=True,conf=0.2)
        ...
        '''
        data_yaml = "C:/Users/yd196/Desktop/project1/config.yaml"  # Create a YAML file describing your dataset

        # Evaluate the model on the validation dataset
        results = model.val(data=data_yaml)
        mAP50 = results.metrics.mAP_50
        mAP50_95 = results.metrics.mAP_50_95

        print(f"mAP50: {mAP50:.4f}")
        print(f"mAP50-95: {mAP50_95:.4f}")'''
    print("keypoints: ",dictt)  
    print(l)
    print("status update for locknut: ",statuses)


    

def eclip():
    model4=YOLO("TRAINED_MODEL _16_12_24/TRAINED_MODEL/eclips/eclips 8s 100ep  best (24).pt") #E CLIP WEIGHTS 
...
def contrast_adjusted(saved_image_path):
    ...
    contrast_adjusted = exposure.adjust_gamma(normalized_image, gamma=20)  # Lower gamma increases brightness
...
def canny(contrast_adj_img):
    ...
    img = img[25:(height // 2)-25, :(widtth//2)-50]

    # Apply Gaussian blur to reduce noise and improve edge detection
    blurred = cv.GaussianBlur(img, (5, 5), 0)

    # Apply Canny edge detection
    edges = cv.Canny(blurred, 300, 600)# if u reduce second value you'll get more details
...
def crop_elc():
    ...
    #model5=YOLO(r"C:\Users\yd196\Desktop\elc datasets\elc yolov8n 100ep best (21).pt")
    model5=YOLO("TRAINED_MODEL _16_12_24/TRAINED_MODEL/elc/elc yolov8n 100ep best (21).pt")
    results5=model5.predict(source=image_path2,save=False,conf=0.6)
...
def drivescrew(image_path1):
    ...
    #model7=YOLO(r"C:\Users\yd196\Desktop\drive screw final working\dataplate drivescrew yolov8m 100ep best (27).pt")
...
def cameracapture(save_path):
    ...
    image_path1 = os.path.join(save_path, "cameracapture_image.jpg")
    ...
    cap1.set(cv2.CAP_PROP_FOCUS, 78)  # Adjust the focus value   # value 78 works perfectly. 85 also good
    #76 works very well 80 doesnt work
    cap1.set(3, 1280)  # Set width

    capture_after_seconds = 15  # Time delay for capturing image
...
def main_function():
    ...
    #time.sleep(5)  # Simulating a process
    st2 = time.time()
...
def excelread():
    ...
    file_path = "/Users/bbhavna/Desktop/CUMMINS PROJECT/my flask folder/trialbook1.xlsx"
...
def run_flask():
    ...
    app.run(debug=True, use_reloader=False)  # use_reloader=False is important to prevent Flask from running twice
...
def home():
    ...
    excel_file = 'my flask folder/trialbook1.xlsx'
    ...
    return render_template('index.html',data=excel_data, images_with_status=images_with_status)




def main():
    """Main function to run the listener, file monitor, and Flask app in parallel."""
